...
router.post("/notify-customer", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { customerData, bookingInfo } = req.body;
    try {
      yield (0,
      notificationService_1.sendCustomerNotification)(customerData, bookingInfo);
      res
        .status(200)
        .json({ success: true, message: "Customer notified successfully!" });
    } catch (error) {
      const errorMessage =
...
router.post("/notify-client", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      yield (0,
      notificationService_1.sendClientNotification)(clientData, customerData, bookingInfo);
      res
        .status(200)
        .json({ success: true, message: "Client notified successfully!" });
    } catch (error) {
      const errorMessage =
        error instanceof Error ? error.message : "An unknown error occurred.";
      console.error("Error in notifying client:", errorMessage);
